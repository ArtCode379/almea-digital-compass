Generate and install the app icon for /tmp/almea-digital-compass.
...
/tmp/almea-digital-compass/app/src/main/res/drawable/icon.png
...
App name: Almea Digital Compass
Type: service
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/almea-digital-compass/app/src/main/res/drawable/icon.png`.
