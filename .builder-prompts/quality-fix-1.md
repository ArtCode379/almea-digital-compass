Fix the Android project at /tmp/almea-digital-compass so the failing quality-fix-1 step passes.
...
Recent failure log:
```text
=== QUALITY CHECK: /tmp/almea-digital-compass ===
...
0: integer expression expected
  OK: Repository: 0
0 entries
  PLACEHOLDER-LIKE: app/src/main/res/drawable/service_3.jpg (colors=36770, entropy=0.671409)
  PLACEHOLDER-LIKE: app/src/main/res/drawable/service_4.jpg (colors=66616, entropy=0.669422)
  PLACEHOLDER-LIKE: app/src/main/res/drawable/service_8.jpg (colors=238, entropy=0.948493)
  OK: 9 images
  OK: All images valid
FAIL: 3 placeholder-like drawable image(s); use real photos or filesystem-backed imagegen output, not local generated placeholders
  ...
  OK: icon.png (208420B, 512x512, rounded opaque canvas, transparent corners)
  OK: Application class ServiceApplication exists
  OK: HomeScreen.kt: 249 lines
