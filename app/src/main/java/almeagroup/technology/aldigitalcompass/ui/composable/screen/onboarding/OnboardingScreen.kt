...
private val onboardingPagesContent = listOf<OnboardingContent>(
    OnboardingContent(
        titleRes = R.string.rbvrh_page_1_title,
        descriptionRes = R.string.rbvrh_page_1_description,
        imageRes = R.drawable.rbvrh_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.rbvrh_page_2_title,
        descriptionRes = R.string.rbvrh_page_2_description,
        imageRes = R.drawable.rbvrh_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.rbvrh_page_2_title,
